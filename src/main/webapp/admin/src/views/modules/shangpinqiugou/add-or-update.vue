    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="求购商品" prop="name">
                              <el-input v-model="ruleForm.name"
                                        placeholder="求购商品" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="求购商品" prop="name">
                                  <el-input v-model="ruleForm.name"
                                            placeholder="求购商品" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="求购人" prop="qgrid">
                              <el-input v-model="ruleForm.qgrid"
                                        placeholder="求购人" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="求购人" prop="qgrid">
                                  <el-input v-model="ruleForm.qgrid"
                                            placeholder="求购人" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="联系方式" prop="phoen">
                              <el-input v-model="ruleForm.phoen"
                                        placeholder="联系方式" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="联系方式" prop="phoen">
                                  <el-input v-model="ruleForm.phoen"
                         ...
                         <el-col :span="12">
                             <el-form-item class="input" v-if="type!='info'" type="number" label="期望价格" prop="money">
                                 <el-input v-model="ruleForm.money" type="number"
                                           placeholder="期望价格"></el-input>
                             </el-form-item>
                             <div v-else>
                                 <el-form-item class="input" label="期望价格" prop="money">
                                     <el-input v-model="ruleForm.money"
                                               placeholder="期望价格" readonly></el-input>
                                 </el-form-item>
                             </div>
                         </el-col>
            </el-row>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        name: [
                        { required: true, message: '求购商品不能为空', trigger: 'blur' },
                    ],

                        qgrid: [
                        { required: true, message: '求购人不能为空', trigger: 'blur' },
                    ],
                        ...
                        money: [
                        { required: true, message: '期望价格不能为空', trigger: 'blur' },
                    ],
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='qgrid'){
                                     this.ruleForm.qgrid = obj[o];
                                     this.ro.qgrid = true;
                                     continue;
                                 }

                                 if(o=='phoen'){
                                     this.ruleForm.phoen = obj[o];
                                     this.ro.phoen = true;
                                     continue;
                                 }
